  ...
  const onFinish = async (values) => {
    try {
      ...
      const examData = {
        ...
        final_exam_start_date: values.exam_date[0].format("YYYY-MM-DD HH:mm:ss"),
        final_exam_end_date: values.exam_date[1].format("YYYY-MM-DD HH:mm:ss"),
        final_exam_duration_minutes: values.duration_minutes,
      };
  ...
  return (
    ...
    >
      ...
      <Form.Item
        name="chapter_id"
        label="Chapter ID"
        rules={[{ required: true, message: 'Please input chapter ID!' }]}
      >
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: 'Please input pass course ID!' }]}
      >
        <InputNumber style={{ width: '100%' }} />
      </Form.Item>
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: 'Please input fail course ID!' }]}
      >
        <InputNumber style={{ width: '100%' }} />
      </Form.Item>
